...
export const Home = () => {
    ...
    return (
        ...
        <div className='flex flex-col w-full min-h-full ml-8 mt-10 pr-20 bg-b'>
            ...
            {tickets.length === 0 && <span className='italic h-100 flex items-center justify-center mt-5 text-gray-500 ml-3 text-center'>No active tickets to display, navigate to Class to find live office hour sessions</span>}
