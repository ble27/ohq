...
export const Header = () => {
  return (
    <>
      <nav className='flex flex-row items-center sticky top-0 z-100 h-20 border-b-1 bg-white border-gray-200 shadow p-5'>
        <Link to='/' className='w-1/3 font-sans text-2xl font-semibold'> MyQueue</Link> 
