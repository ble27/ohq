...
export const Body = () => {
  return (
   <div className="flex flex-col items-center text-black bg-yellow-50"> 
      <div className="flex flex-col pt-24 sm:pt-32 md:pt-40 lg:pt-48 text-3xl sm:text-4xl md:text-5xl 
      pl-12 sm:pl-15 md:pl-20 lg:pl-30 xl:pl-35 leading-10 md:leading-14 lg:leading-16 font-sans 
      w-full max-w-[900px] font-semibold mb-5 mr-5">
        <div>
      ...
      <div className='w-full py-24 md:py-32 lg:py-40'>
        <span className='pl-8 md:pl-16 lg:pl-18 text-5xl'> Built to... </span>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 p-5 md:px-15
            ...
            {/* Card 1*/}
            <div className='flex flex-col bg-yellow-200 border-1 border-black/50 min-h-120 rounded-3xl'>
              <div className='flex flex-col h-full pl-4'>
                  ...
                  <div className='flex flex-col flex-2 text-5xl md:text-6xl lg:text-5xl lg:tracking-tight pb-6'>
                      Sync in real time
            ...
            {/* Card 2 */}
            <div className='flex flex-col bg-orange-200 border-1 border-black/50 min-h-120 rounded-3xl'>
              <div className='flex flex-col h-full pl-4'>
                  <div className='flex flex-2 pt-5 pl-1 pr-7 lg:text-xl font-semibold justify-between items-start'>
                    Location Alert
            ...
            {/* Card 4 */}
            <div className='flex flex-col bg-emerald-200 border-1 border-black/50 min-h-120 rounded-3xl overflow-hidden'>
              <div className='flex flex-col h-full pl-4'>
                  <div className='flex flex-2 pt-5 pl-1 pr-7 lg:text-xl font-semibold justify-between items-start'> 
            ...
            {/* Card 3 */}
            <div className='flex flex-col bg-blue-200 border-1 border-black/50 min-h-120 rounded-3xl'>
              <div className='flex flex-col h-full pl-4'>
                  <div className='flex flex-2 pt-5 pl-1 pr-7 lg:text-xl font-semibold justify-between items-start'>
                    Management Platform
        ...
        <div className='flex flex-col w-full py-20 pl-8 bg-yellow-100/20 border-t-1 border-black/50'>
          ...
          <span className='flex flex-1 text-lg text-center justify-center'>This website is not affiliated with Texas A&M University</span>
